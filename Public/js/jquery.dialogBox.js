 	...
 	DialogBox.prototype = {	
 		...
 		create: function(element){
 			...
 			if(!title){
 				...
 				if(!hasClose){
					dialogHTML[0] = '<section class="dialog-box"><div class="dialog-box-container"><div class="dialog-box-title"><h5>'+ title + '</h5></div><div class="dialog-box-content"></div>';
 				}else{					
 					dialogHTML[0] = '<section class="dialog-box"><div class="dialog-box-container"><div class="dialog-box-title"><h5>'+ title + '</h5><span class="span-btn dialog-box-close">×</span></div><div class="dialog-box-content"></div>';
 				}
 			}
