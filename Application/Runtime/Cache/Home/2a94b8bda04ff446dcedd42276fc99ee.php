...
<!--     <script type="text/javascript" src="/Public/js/jquery.dialogBox.js"></script>
	...
	<div class="container">
		<div class="recent">
			<a href="<?php echo U('Home/Article/articledetail',array('articleid' => $NewArticle['0']['articleid']));?>">
				<h3><span>最新文章</span><span class="recent-title"><?php echo ($NewArticle["0"]["title"]); ?></span></h3>
				<div>
					<img src="<?php echo ($NewArticle["0"]["img"]); ?>" alt="">
				</div>
				<small><?php echo ($NewArticle["0"]["summary"]); ?></small><br>
				<p class="readmore">继续阅读<i class="icon-arrow-right"></i></p>
			</a>
		</div>
		...
		<div class="articlelist">
			...
			<ul>
				<?php if(is_array($Articles)): foreach($Articles as $key=>$v): ?><li>
						...
						<a href="<?php echo U('Home/Article/articledetail',array('articleid' => $v['articleid']));?>"><?php echo ($v["title"]); ?></a>
						</p>
						...
						<div class="articleinfo"><?php echo ($v["summary"]); ?></div>
						<p class="articletag">
		...
		<!-- <div class="links">
			<h3>碎碎念</h3>
			<ul>
				<li><a href="javascript:;"><i class="icon-link"></i>~~~ </a></li>
			</ul>
		</div> -->
	</div>
	<!DOCTYPE html>
